...
int main(int argc, char *argv[])
{
    ...
    {
        processObjects.push_back(processObjects()); //with processObjects(), dont forget the () :)
    }
    
    
    //good read -> https://www.technical-recipes.com/2011/priority-queues-and-min-priority-queues-in-c/
    priorty_queue<SimulationEvent*, vector<SimulationEvent*>, eventPtrComparison> eventPriorityQueue;
